...
# Utilisable avec F5 dans VS Code
...
def main(session):
    ...
    if QI_AVAILABLE and hasattr(session, 'service'):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Virtual Camera NAO - Version universelle")
    ...
    print("\n" + "=" * 60)
    print("📷 NAO VIRTUAL CAMERA - VERSION F5")
    print("=" * 60)
